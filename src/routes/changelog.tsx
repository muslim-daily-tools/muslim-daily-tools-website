    ...
    versions: [
      {
        ...
        changes: [
          {
            category: 'improved',
            items: [{ description: 'changelog:quranTab.v4150.improved1' }],
          },
        ],
      },
      {
        ...
        changes: [
          {
            category: 'new',
            items: [{ description: 'changelog:quranTab.v4140.new1' }],
          },
          {
            category: 'improved',
            items: [{ description: 'changelog:quranTab.v4140.improved1' }],
          },
          {
            category: 'fixed',
            items: [
              { description: 'changelog:quranTab.v4140.fixed1' },
              { description: 'changelog:quranTab.v4140.fixed2' },
            ],
          },
        ],
      },
        ...
        changes: [
          {
            category: 'improved',
            items: [
              { description: 'changelog:quranTab.v4132.improved1' },
              { description: 'changelog:quranTab.v4132.improved2' },
            ],
          },
        ],
      },
        ...
        changes: [
          {
            category: 'new',
            items: [
              { description: 'changelog:quranTab.v4130.new1' },
              { description: 'changelog:quranTab.v4130.new2' },
              { description: 'changelog:quranTab.v4130.new3' },
              { description: 'changelog:quranTab.v4130.new4' },
            ],
          },
          {
            category: 'improved',
            items: [
              { description: 'changelog:quranTab.v4130.improved1' },
              { description: 'changelog:quranTab.v4130.improved2' },
              { description: 'changelog:quranTab.v4130.improved3' },
              { description: 'changelog:quranTab.v4130.improved4' },
            ],
          },
          {
            category: 'fixed',
            items: [
              { description: 'changelog:quranTab.v4130.fixed1' },
              { description: 'changelog:quranTab.v4130.fixed2' },
              { description: 'changelog:quranTab.v4130.fixed3' },
            ],
          },
        ],
      },
