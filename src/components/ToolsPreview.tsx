        ...
        <StaggerItem key={tool.label} variant="scaleIn">
          ...
          >
            <div className="flex flex-col items-center">
              <div
                className={`w-24 h-24 rounded-xl border border-border bg-card flex items-center justify-center overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_12px_rgba(0,0,0,0.25)] transition-all duration-200 hover:border-border/80 hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_8px_24px_rgba(0,0,0,0.35)] ${tool.fullBleed ? 'p-0' : 'p-2'}`}
              >
                <img
                  src={tool.logo}
                  alt={tool.label}
