      ...
      {tool.links.map((link) => {
        ...
        return (
          <a
            ...
            className="inline-flex items-center gap-1.5 h-8 px-3 rounded-full border border-border bg-background text-xs font-medium text-foreground transition-colors hover:border-primary hover:text-primary"
          >
...
function ToolCard({
  ...
  return (
    <article
      ...
      aria-label={title}
      className={cn(
        'group flex h-full flex-col gap-5 rounded-2xl border border-border bg-card p-6 shadow-sm md:p-8',
    ...
    >
      <div
        className={cn(
          'shrink-0 overflow-hidden rounded-xl border border-border bg-background flex items-center justify-center',
